            ...
            child: ListView(
              ...
              children: [
                ...
                FadeTransition(
                  ...
                  child: Text('Your Overview', style: TextStyle(fontSize: 16.5 * scale, fontWeight: FontWeight.w800, color: colors.textPrimary)),
                ),
                ...
                FadeTransition(
                  ...
                  child: Row(
                    children: [
                      Text('Nutrient Summary', style: TextStyle(fontSize: 15.5 * scale, fontWeight: FontWeight.w800, color: colors.textPrimary)),
                      const Spacer(),
                      GestureDetector(
                        onTap: widget.onNutrientSeeDetails,
                        child: Row(
                          children: [
                            Text('See Details', style: TextStyle(fontSize: 12 * scale, fontWeight: FontWeight.w700, color: colors.iconPurple)),
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: colors.isDark
                  ? const [Color(0xFF13111C), Color(0xFF0D0C14)]
                  : const [Color(0xFFEFEAFA), Color(0xFFF3F0FB)],
            ),
          ),
        ),
        Positioned(
          ...
          width: 70,
          child: Opacity(
            opacity: colors.isDark ? 0.15 : 0.35,
            child: CustomPaint(painter: _DotColumnPainter(dotColor: colors.iconPurple)),
          ),
        ),
        Positioned(
          bottom: 0,
          ...
          height: 220,
          child: Opacity(
            opacity: colors.isDark ? 0.12 : 0.25,
            child: CustomPaint(painter: _DotColumnPainter(dotColor: colors.iconPurple)),
          ),
        ),
        Positioned(
          ...
          right: 10,
          child: Opacity(
            opacity: colors.isDark ? 0.15 : 0.3,
            child: Icon(Icons.eco_rounded, size: 90, color: colors.iconPurple),
          ),
        ),
      ],
    );
...
class _DotColumnPainter extends CustomPainter {
  _DotColumnPainter({this.dotColor = const Color(0xFF7C5CFC)});
    ...
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: colors.surface.withValues(alpha: colors.isDark ? 0.90 : 0.70),
            borderRadius: BorderRadius.circular(radius),
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(colors: [colors.iconPurple, colors.iconGreen]),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Text('Hello, $userName! ', style: TextStyle(fontSize: 17 * uiScale, fontWeight: FontWeight.w800, color: colors.textPrimary)),
                  Text('👋', style: TextStyle(fontSize: 15 * uiScale)),
                ],
              ),
              Text('Track your progress & build healthier habits.',
                  style: TextStyle(fontSize: 11 * uiScale, height: 1.3, color: colors.textSecondary)),
            ],
          ),
        ),
        ...
        child: Stack(
          ...
          children: [
            Container(
              ...
              child: Icon(widget.icon, size: 17 * widget.uiScale, color: colors.iconPurple),
            ),
            if (widget.showDot)
              Positioned(
                top: 1,
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(shape: BoxShape.circle, color: const Color(0xFFE0525C), border: Border.all(color: colors.surface, width: 1.4)),
                ),
              ),
          ],
        ),
...
class _RingGaugePainter extends CustomPainter {
  _RingGaugePainter({required this.progress, this.trackColor = const Color(0xFFE4DCF9), this.progressColor = const Color(0xFF6C4EF5)});
  ...
  @override
  bool shouldRepaint(covariant _RingGaugePainter oldDelegate) => oldDelegate.progress != progress || oldDelegate.trackColor != trackColor || oldDelegate.progressColor != progressColor;
}
    ...
    return _GlassCard(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 6 * uiScale),
          Text(item.label, style: TextStyle(fontSize: 10.5 * uiScale, fontWeight: FontWeight.w700, color: colors.textPrimary)),
          Text('${item.current} / ${item.target}', style: TextStyle(fontSize: 9.5 * uiScale, color: colors.textSecondary)),
          Text(item.unit, style: TextStyle(fontSize: 8.5 * uiScale, color: colors.textMuted)),
          SizedBox(height: 6 * uiScale),
          AnimatedBuilder(
            animation: anim,
            builder: (context, _) {
    ...
    return _GlassCard(
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text('Calories Trend', style: TextStyle(fontSize: 13.5 * uiScale, fontWeight: FontWeight.w800, color: colors.iconPurple)),
              const Spacer(),
              GestureDetector(
                onTap: onRangeTap,
                child: Row(
                  children: [
                    Text('This Week', style: TextStyle(fontSize: 10.5 * uiScale, color: colors.textSecondary)),
                    Icon(Icons.keyboard_arrow_down, size: 14 * uiScale, color: colors.textSecondary),
                  ],
                ),
              ),
            ],
...
class _LineChartPainter extends CustomPainter {
  _LineChartPainter({
    ...
    required this.highlightIndex,
    required this.uiScale,
    this.gridColor = const Color(0xFFE4E0F2),
    this.textColor = const Color(0xFF9A96A8),
    this.lineColor = const Color(0xFF6C4EF5),
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final labelStyle = TextStyle(color: textColor, fontSize: 9.5 * uiScale);
    for (int i = 0; i <= 4; i++) {
    ...
    if (progress > 0.85 && highlightIndex < points.length) {
      ...
      final tooltipPaint = Paint()..color = lineColor;
  ...
  bool shouldRepaint(covariant _LineChartPainter oldDelegate) =>
      oldDelegate.progress != progress || oldDelegate.gridColor != gridColor || oldDelegate.textColor != textColor || oldDelegate.lineColor != lineColor;
}
    ...
    return _GlassCard(
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text('Macro Distribution', style: TextStyle(fontSize: 13.5 * uiScale, fontWeight: FontWeight.w800, color: colors.iconPurple)),
              const Spacer(),
              GestureDetector(
                onTap: onRangeTap,
                child: Row(
                  children: [
                    Text('Today', style: TextStyle(fontSize: 10.5 * uiScale, color: colors.textSecondary)),
                    Icon(Icons.keyboard_arrow_down, size: 14 * uiScale, color: colors.textSecondary),
                  ],
                ),
              ),
                  ...
                  return SizedBox(
                    ...
                    child: CustomPaint(
                      ...
                      child: Center(
                        child: Text.rich(
                          TextSpan(children: [
                            TextSpan(text: centerCalories, style: TextStyle(fontSize: 15 * uiScale, fontWeight: FontWeight.w800, color: colors.textPrimary)),
                            TextSpan(text: '\nkcal', style: TextStyle(fontSize: 9.5 * uiScale, color: colors.textMuted)),
                          ]),
                    ...
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 8 * uiScale),
                          Expanded(child: Text(s.label, style: TextStyle(fontSize: 11.5 * uiScale, color: colors.textSecondary))),
                          Text('${s.percent.round()}%', style: TextStyle(fontSize: 11.5 * uiScale, fontWeight: FontWeight.w700, color: colors.textPrimary)),
                        ],
                      ),
                    );
                  }).toList(),
      ...
      child: AnimatedScale(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Text('View Insights', style: TextStyle(fontSize: 11.5 * widget.uiScale, fontWeight: FontWeight.w700, color: colors.iconPurple)),
              SizedBox(width: 5 * widget.uiScale),
              Icon(Icons.arrow_forward, size: 13 * widget.uiScale, color: colors.iconPurple),
            ],
          ),
        ),
      ),
        ...
        _GlassCard(
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Text('Top Foods This Week', style: TextStyle(fontSize: 13.5 * uiScale, fontWeight: FontWeight.w800, color: colors.iconPurple)),
                  const Spacer(),
                  GestureDetector(
                    onTap: onTopFoodsSeeAll,
                    child: Row(
                      children: [
                        Text('See All', style: TextStyle(fontSize: 11 * uiScale, fontWeight: FontWeight.w700, color: colors.iconPurple)),
                        Icon(Icons.chevron_right, size: 14 * uiScale, color: colors.iconPurple),
                      ],
                    ),
                  ),
                ],
        ...
        _GlassCard(
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Text('Goal Progress', style: TextStyle(fontSize: 13.5 * uiScale, fontWeight: FontWeight.w800, color: colors.iconPurple)),
                  const Spacer(),
                  GestureDetector(
                    onTap: onEditGoalsTap,
                    child: Row(
                      children: [
                        Text('Edit Goals', style: TextStyle(fontSize: 11 * uiScale, fontWeight: FontWeight.w700, color: colors.iconPurple)),
                        Icon(Icons.chevron_right, size: 14 * uiScale, color: colors.iconPurple),
                      ],
                    ),
                  ),
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Image.asset(
                    ...
                    errorBuilder: (context, error, stackTrace) =>
                        Icon(Icons.ramen_dining_outlined, size: 18 * widget.uiScale, color: colors.textMuted),
                  ),
                ),
              ),
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(widget.food.name, style: TextStyle(fontSize: 12.5 * widget.uiScale, fontWeight: FontWeight.w700, color: colors.textPrimary)),
                    Text(widget.food.timesLabel, style: TextStyle(fontSize: 10.5 * widget.uiScale, fontWeight: FontWeight.w600, color: colors.iconGreen)),
                  ],
                ),
              ),
              Icon(Icons.chevron_right, size: 16 * widget.uiScale, color: colors.textMuted),
            ],
          ),
        ),
      ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(goal.label, style: TextStyle(fontSize: 12 * uiScale, fontWeight: FontWeight.w700, color: colors.textPrimary)),
                Text(goal.progressLabel, style: TextStyle(fontSize: 10 * uiScale, color: colors.textSecondary)),
          ...
          SizedBox(width: 8 * uiScale),
          Text('${(goal.fraction * 100).round()}%', style: TextStyle(fontSize: 11.5 * uiScale, fontWeight: FontWeight.w800, color: colors.textPrimary)),
        ],
      ),
    );
  }
    ...
    return SafeArea(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: colors.cardBorder),
          boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: colors.isDark ? 0.25 : 0.08), blurRadius: 20, offset: const Offset(0, 8))],
        ),
        child: Row(
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(item.icon, size: 18 * uiScale, color: selected ? colors.iconPurple : colors.textMuted),
                    AnimatedSize(
                      duration: const Duration(milliseconds: 200),
                      child: selected
                          ? Padding(
                              padding: EdgeInsets.only(top: 2 * uiScale),
                              child: Text(item.label, style: TextStyle(fontSize: 8.5 * uiScale, fontWeight: FontWeight.w700, color: colors.iconPurple)),
                            )
